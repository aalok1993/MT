...
$blender --background --python Generate_Dataset.py -- --number_of_vids 10 --dataroot '/media/laurenz/Seagate Backup Plus Drive/ShapeNet/ShapeNetCore.v2/' --outroot '/home/laurenz/IITGN/motion_transfer/data_generation/data/'
